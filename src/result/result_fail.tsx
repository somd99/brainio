        ...
        <div className="container kid-font" style={{display:"flex", justifyContent:"center", alignItems:"center", height:"100vh"}}>
            <Col>
                ...
                <div style={{display:"flex", justifyContent:"center"}}>   
                    ...
                    <Button onClick={()=>setLink(true)} variant="light" className="bg-joy-purple3 duration-300 transform ease-in-out hover:bg-joy-purple2  border-2 border-white rounded-xl text-3xl" size="lg" block style={{color:"white"}}>เจอกันวันพรุ่งนี้</Button>
                </div>
            </Col>
